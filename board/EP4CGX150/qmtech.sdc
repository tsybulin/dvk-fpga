...
create_clock -name clk_con -period 1000.0 {topboard22:kernel|pdp2011:cpu|console:cons|clk}
...
set_false_path -from [get_keepers {topboard22:kernel|wbc_rst:reset|key_down}] -to [get_keepers {topboard22:kernel|wbc_rst:reset|key_syn[0]}]
set_false_path -from {topboard22:kernel|wbc_rst:reset|pwr_event} -to {topboard22:kernel|wbc_rst:reset|count_dc[*]}
set_false_path -from {topboard22:kernel|wbc_rst:reset|pwr_event} -to {topboard22:kernel|wbc_rst:reset|count_pw[*]}
set_false_path -from {topboard22:kernel|wbc_rst:reset|pwr_event} -to {topboard22:kernel|wbc_rst:reset|sys_dclo}
set_false_path -from {topboard22:kernel|wbc_rst:reset|pwr_event} -to {topboard22:kernel|wbc_rst:reset|sys_rst}
set_false_path -from {topboard22:kernel|wbc_rst:reset|pwr_event} -to {topboard22:kernel|wbc_rst:reset|pwr_rst}

set_false_path -from [get_clocks {clk_con}] -to [get_clocks {pll1|altpll_component|auto_generated|pll1|clk[2]}]
